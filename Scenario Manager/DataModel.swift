...
class DataModel {
    ...
    private init() {
        ...
        if fileManager.fileExists(atPath: filePath!){
            ...
            let row62Scenario = Scenario(number: "63", title: "Magma Pit", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "15 Gold Each")], summary: "Kill all enemies.\n\nIf the reports are true, there's gold to be found on this active volcano high in the Watcher Mountains. As always, come prepared for battle, as nothing in Gloomhaven comes easily.", locationString: "M-1, Watcher Mountains", isManuallyUnlockable: true, mainCellBGImage: "scenarioMgrMap63")
            allScenarios.append(row62Scenario)
            
            let row63Scenario = Scenario(number: "64", title: "Underwater Lagoon", completed: false, requirementsMet: false, requirements: ["Water Breathing" : true], isUnlocked: true, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "10XP Each")], summary: "Kill all enemies.\n\nYou came by the map easily enough, so there must be a catch. Nevertheless, you're raring to take advantage of your water breathing capability and explore this mysterious lagoon way out in the Misty Sea. The hired boat's captain will only come so close to the shore of this place, so bring a dinghy with you.", locationString: "R-16, Misty Sea", isManuallyUnlockable: false, mainCellBGImage: "scenarioMgrMap64")
            allScenarios.append(row63Scenario)
            
            let row64Scenario = Scenario(number: "65", title: "Sulfur Mine", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["Ancient Technology"], rewards: [NSAttributedString(string: "Ancient Drill design (Item 112)")], summary: "Kill all enemies and loot all treasure tiles.\n\nEveryone knows where this place is due to the overwhelming stench that emanates for miles in all directions. Not so well-known is the fact that ancient technology of some sort lies deep within the mine. You know a few folks who would love to get their hands on such tech.", locationString: "L-5, Watcher Mountains", isManuallyUnlockable: true, mainCellBGImage: "scenarioMgrMap65")
            allScenarios.append(row64Scenario)
            
            let row65Scenario = Scenario(number: "66", title: "Clockwork Cove", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["Ancient Technology"], rewards: [NSAttributedString(string: "None")], summary: "Occupy pressure plate (e).\n\nEver on the lookout for lost technology, this cove up along the coast near town seems promising. Rumor has it that the place is chocked full of gears and levers (and traps, of course).", locationString: "G-14, Gloomhaven", isManuallyUnlockable: true, mainCellBGImage: "scenarioMgrMap66")
            allScenarios.append(row65Scenario)
            
            let row66Scenario = Scenario(number: "67", title: "Arcane Library", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["Ancient Technology"], rewards: [NSAttributedString(string: "Power Core (Item 132)")], summary: "Kill the Arcane Golem.\n\nYou have discovered the location of the old mystic Morsbane's Tower. The place is long past its prime but still home to ancient treasure, if rumors are to be believed.", locationString: "K-2, Watcher Mountains", isManuallyUnlockable: true, mainCellBGImage: "scenarioMgrMap67")
            allScenarios.append(row66Scenario)
            
            let row67Scenario = Scenario(number: "68", title: "Toxic Moor", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "Two(2) Major Healing potions (Item 027)")], summary: "Kill all enemies and protect the Tree (a).\n\nYou've heard tell of a great tree that grows somewhere deep within the Lingering Swamp. It supposedly possesses great healing power, but is rumored to be the target of vile creatures bent on its destruction. Whether it be a soft spot for nature, or the hope of finding valuable potions, you need to get down there and defend the tree.", locationString: "N-8, Lingering Swamp", isManuallyUnlockable: true, mainCellBGImage: "scenarioMgrMap68")
            allScenarios.append(row67Scenario)
            
            let row68Scenario = Scenario(number: "69", title: "Well of the Unfortunate", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "15 Gold Each")], summary: "Bring the doll to the well.\n\nThere's an old well up along the Stone Road that's supposed to grant wishes to those who throw items of value into its depths. Though you're not particularly superstitious, your curiosity drives you to go see for yourself.", locationString: "F-8, Stone Road", isManuallyUnlockable: true, mainCellBGImage: "scenarioMgrMap69")
            allScenarios.append(row68Scenario)
            
            let row69Scenario = Scenario(number: "70", title: "Chained Isle", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "+2 Prosperity")], summary: "Kill all demons.\n\nYou've heard enough about the haunted island to fill several story books. No one dares go near the remote hunk of rock deep in the Misty Sea for fear of the tormented souls haunting the shore. A recently-discovered journal details the existence of a cohort of demons somewhere on the island, which could be the source of the discomfited souls. Wipe out the demons, and maybe the Chained Isle will become a destination once again.", locationString: "J-17, Misty Sea", isManuallyUnlockable: true, mainCellBGImage: "scenarioMgrMap70")
            allScenarios.append(row69Scenario)
            
            let row70Scenario = Scenario(number: "71", title: "Windswept Highlands", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "Two(2) Major Power potions")], summary: "Loot all treasure tiles, then all characters must escape through exit (a).\n\nYou've uncovered an alchemist's log book, wherein you read about a plant (jerry root) which can be used to formulate a powerful concoction. If you can retrieve this plant from the highlands along the Serpent's Kiss River, you might be able to fetch some decent coin for it.", locationString: "K-5, Serpent's Kiss River", isManuallyUnlockable: true, mainCellBGImage: "scenarioMgrMap71")
            allScenarios.append(row70Scenario)
            
            let row71Scenario = Scenario(number: "72", title: "Oozing Grove", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "+1 Reputation"), NSAttributedString(string: "+1 Prosperity")], summary: "Destroy all trees and kill all Oozes.\n\nTown librarian Dominic fears the military will quash his attempts to chronicle Gloomhaven history. If you scratch Councilman Greymare's back, the councilman will do what he can to protect Dominic. Clear Greymare's Corpsewood estate of an Ooze infestation.", locationString: "H-12, Corpsewood", isManuallyUnlockable: false, mainCellBGImage: "scenarioMgrMap72")
            allScenarios.append(row71Scenario)
            
            let row72Scenario = Scenario(number: "73", title: "Rockslide Ridge", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "+1 Reputation")], summary: "Kill all enemies and loot all treasure tiles.\n\nDominic the librarian implores you to recover a Codex that contains vital information about Gloomhaven's ancient history. Problem is, it's purportedly in the hands of a band of Inox.", locationString: "N-5, Watcher Mountains", isManuallyUnlockable: false, mainCellBGImage: "scenarioMgrMap73")
            allScenarios.append(row72Scenario)
            
            let row73Scenario = Scenario(number: "74", title: "Merchant Ship", completed: false, requirementsMet: false, requirements: ["High Sea Escort" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "10 Gold Each"), NSAttributedString(string: "+2 Prosperity")], summary: "Kill all enemies and keep the ship afloat.\n\nMerchant Gavin has hired you to put an end to the sea piracy that's destroying his business. Board one of his ships and let the pirates come to you, then finish them off for good.", locationString: "I-14, Misty Sea", isManuallyUnlockable: false, mainCellBGImage: "scenarioMgrMap74")
            allScenarios.append(row73Scenario)
            
            let row74Scenario = Scenario(number: "75", title: "Overgrown Graveyard", completed: false, requirementsMet: false, requirements: ["Grave Job" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "60 Gold Each")], summary: "Dig up all graves and kill the Bloated Regent.\n\nNotorious fence Red Nick thinks you will make great grave robbers. Apparently there's much loot to be pilfered from a cemetary out on the east side of the Corpsewood, assuming the job isn't beneath you.", locationString: "G-12, Corpsewood", isManuallyUnlockable: false, mainCellBGImage: "scenarioMgrMap75")
            allScenarios.append(row74Scenario)
            
            let row75Scenario = Scenario(number: "76", title: "Harrower Hive", completed: false, requirementsMet: false, requirements: ["Bravery" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "None")], summary: "Reveal all rooms and kill all enemies.\n\nThere's a group of Harrowers slaughtering people out along the East Road, and they need to be stopped. Problem is, no-one has stepped up to take on this extremely dangerous task. If you're up to it, head out to their hive in the Watcher Mountains and wipe them out.", locationString: "L-3, Watcher Mountains", isManuallyUnlockable: true, mainCellBGImage: "scenarioMgrMap76")
            allScenarios.append(row75Scenario)
            
            let row76Scenario = Scenario(number: "77", title: "Vault of Secrets", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "5 XP Each")], summary: "Loot all treasure tiles and kill all City Guards before the alarm is raised.\n\nLibrarian Dominic's beloved Codex was stolen from him by a mysterious group calling themselves The Vigil. He has directed you to sneak in to their Vault of Secrets and recover the Codex without raising an alarm.", locationString: "B-17, Gloomhaven", isManuallyUnlockable: false, mainCellBGImage: "scenarioMgrMap77")
            allScenarios.append(row76Scenario)
            
            let row77Scenario = Scenario(number: "78", title: "Sacrifice Pit", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "+3 Reputation")], summary: "Kill all enemies and stop the sacrifice.\n\nYou've followed a cloaked figure to what you believe could be the Ravens' hideout. This may be your chance cleanse the city of these vile cultists for good.", locationString: "B-14, Gloomhaven", isManuallyUnlockable: false, mainCellBGImage: "scenarioMgrMap78")
            allScenarios.append(row77Scenario)
            
            let row78Scenario = Scenario(number: "79", title: "Lost Temple", completed: false, requirementsMet: false, requirements: ["Fish's Aid" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "15 Gold Each")], summary: "Kill the Betrayer.\n\nAn old bandit, Fish, tells you that the metal sphere and rod you are puzzling over is in fact a key to a temple that contains untold riches. You decide to take Fish at his word and follow him out to the swamps to scare up some gold.", locationString: "K-12, Lingering Swamp", isManuallyUnlockable: false, mainCellBGImage: "scenarioMgrMap79")
            allScenarios.append(row78Scenario)
            
            let row79Scenario = Scenario(number: "80", title: "Vigil Keep", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "10 XP Each")], summary: "All characters must loot one treasure tile and then escape.\n\nYour investigations into the Vigil have landed you in a jail cell deep within their keep. A friend offers a bit of help, but you must still regain your weapons and items if you're going to escape this place.", locationString: "K-1, Watcher Mountains", isManuallyUnlockable: false, mainCellBGImage: "scenarioMgrMap80")
            allScenarios.append(row79Scenario)
            
            let row80Scenario = Scenario(number: "81", title: "Temple of the Eclipse", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "10 XP Each")], summary: "Kill the Colorless.\n\nJust when you thought that coin you bought off the strange Savvas merchant was a worthless bauble, an Aesther tells you its markings lead to a mysterious temple. This proves to be too enticing to ignore, so you head out to the Dagger Forest ready to explore.", locationString: "D-2, Dagger Forest", isManuallyUnlockable: false, mainCellBGImage: "scenarioMgrMap81")
            allScenarios.append(row80Scenario)
            
            let row81Scenario = Scenario(number: "82", title: "Burning Mountain", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "+1 Reputation OR"), NSAttributedString(string: "-1 Reputation, -2 Prosperity")], summary: "Sacrifice one artifact or escape with all artifacts.\n\nThat band of Inox you passed on the road were fleeing what their Shaman called 'A Mountain Aflame'. After coming upon the scorched Inox village, you decide to brave the climb to the peak beyond and see just what's really going on.", locationString: "M-6, Watcher Mountains", isManuallyUnlockable: false, mainCellBGImage: "scenarioMgrMap82")
            allScenarios.append(row81Scenario)
            
            let row82Scenario = Scenario(number: "83", title: "Shadows Within", completed: false, requirementsMet: false, requirements: ["Bad Business" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "40 Collective Gold")], summary: "Kill all enemies.\n\nThe woman who approached you during a drunken night gambling at the Brown Door caught your attention with a parchment bearing the Raven insignia. She's appealing to you to rescue her kidnapped daughter from the vile cultists. You've got a lead on their whereabouts, so it's time to go knock some heads.", locationString: "C-15, Gloomhaven", isManuallyUnlockable: false, mainCellBGImage: "scenarioMgrMap83")
            allScenarios.append(row82Scenario)
            
            let row83Scenario = Scenario(number: "84", title: "Crystalline Cave", completed: false, requirementsMet: false, requirements: ["Tremors" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "Resonant Crystal (Item 133)"), NSAttributedString(string: "+1 Prosperity")], summary: "Kill all enemies and protect the crystal (a).\n\nThat crystal you found turns out to contain earth-shaking power - quite literally. After consulting with a Quatryl over what to do about it, you're off to restore the crystal to its proper place and forever quiet the rumblings.", locationString: "D-12, Copperneck Mountains", isManuallyUnlockable: false, mainCellBGImage: "scenarioMgrMap84")
            allScenarios.append(row83Scenario)
            
            let row84Scenario = Scenario(number: "85", title: "Sun Temple", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "Orb of Dawn (Item 121)")], summary: "Kill all enemies.\n\nSun Demons have sought your help in ridding their temple of Night Demons. You begrudgingly agree to assist them.", locationString: "M-3, Watcher Mountains", isManuallyUnlockable: false, mainCellBGImage: "scenarioMgrMap85")
            allScenarios.append(row84Scenario)
            
            let row85Scenario = Scenario(number: "86", title: "Harried Village", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["87"], achieves: ["The Poison's Source"], rewards: [NSAttributedString(string: "+2 Reputation")], summary: "Save seven villagers before five are killed.\n\nFind out what's poisoning the residents of Hook Coast and report back to the City Guard.", locationString: "D-15, Gloomhaven", isManuallyUnlockable: false, mainCellBGImage: "scenarioMgrMap86")
            allScenarios.append(row85Scenario)

            let row86Scenario = Scenario(number: "87", title: "Corrupted Cove", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["86"], unlocks: ["None"], achieves: ["None"], rewards: [NSAttributedString(string: "+1 Reputation"), NSAttributedString(string: "+1 Prosperity")], summary: "Kill the Giant Ooze.\n\nA resident of the Hook Coast points out the source of the poison ravaging his village. You go to a cove just to the south to investigate further.", locationString: "I-9, Gloomhaven", isManuallyUnlockable: false, mainCellBGImage: "scenarioMgrMap87")
