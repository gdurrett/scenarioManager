...
class DataModel {
    ...
    private init() {
        ...
        if fileManager.fileExists(atPath: filePath!){
            ...
            let row51Scenario = Scenario(number: "52", title: "Test Manual Unlock", completed: false, requirementsMet: false, requirements: ["None" : true], isUnlocked: false, unlockedBy: ["None"], unlocks: ["None"], achieves: ["None"], rewards: ["None"], summary: "", location: "", isManuallyUnlockable: true)
